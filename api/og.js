  ...
  try {
    ...
    const translations = {
      ...
      project2: {
        ...
        uk: { title: "Калькулятор", desc: "І стандартний, і бухгалтерський, для будь-яких завдань (створено Анатолієм Зоріним)" },
        es: { title: "Calculadora", desc: "En versión estándar y contable (creado por Anatolii Zorin)" }
      },
      project3: {
